...
describe("MusicNFTMarketplace", function () {
  ...
  let URI = "https://bafybeid2qyl54rqkkcnd5dcqdifubttxv5iicnnz3dsdojpnucvik7hgc4.ipfs.nftstorage.link/"
  ...
  describe("Deployment", function () {
    ...
    it("Should mint then list all the music nfts", async function () {
      expect(await nftMarketplace.balanceOf(nftMarketplace.address)).to.equal(9);
